...
#define PLUGIN_ID				"CTD1"			// Provide a unique 4-character string that identifies this plugin.
#define PLUGIN_NAME				",Color Temp DMX"		// This can be any string. This is the name of the plugin as it appears in the Resolume effects list.
